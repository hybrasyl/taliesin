...
import {
  Autocomplete, Box, Button, Collapse, Dialog, DialogActions, DialogContent,
...
export default function WarpDialog({
  open, tileX, tileY, initial, mapNames, worldMapNames,
  onConfirm, onCancel,
  lockType, defaultType, pointDisplayName, onPointDisplayNameChange,
}: WarpDialogProps) {
  ...
  return (
    <Dialog open={open} onClose={onCancel} maxWidth="md" fullWidth>
      <DialogTitle>
        {initial ? (isWorldMapPoint ? 'Edit Point' : 'Edit Warp') : (isWorldMapPoint ? 'Place Point' : 'Place Warp')}
